...
購入したのは３だけでその後は毎回無料でアップグレードさせてもらっています。
...
上で紹介したパソBlogのグローバルメニューに設置されたページは「ランディングページ」という特殊なページで作っています。これも賢威７には最初から普通に入っていて使えます。
...
***追記：2019/10/20***          
現時点で当サイトは賢威を使用しておりません。と言うより、Wordpressでの運用をやめた都合上で賢威を利用出来なくなっております。
時間が空けば、静的サイトジェネレーターHUGO用に賢威テンプレートを移植する事も考えますが現時点ではそういう状況です。
